 ...
 *
 * Populates the Neon PostgreSQL database with initial phone and brand data.
 * Safe to run multiple times (idempotent - skips if data already exists).
 *
...
import { brands, phones } from "./src/db/schema";
...
const seedPhones = [
  ...
  },
  {
    ...
    reviewLinks: [
      { platform: "YouTube", title: "Z Fold6 摺疊機評測", url: "https://youtube.com" },
    ],
  },
  {
    id: "xiaomi-15-ultra",
  ...
  },
  {
    ...
    images: [sogi("OnePlus_oneplus-15t_0926064925513_360x270")],
    msrp: 39900,
    price: 35900,
    ranking: 11,
    specs: {
...
async function main() {
  ...
  const existingBrands = Number(brandCount.count);
  ...
  console.log(`\n✅ Seed complete! ${seedBrands.length} brands, ${seedPhones.length} phones inserted.`);
}
